...
MONSTER_SPECIES_DATA = {
    ...
    "Skeleton": {
        "prompt": "An animated skeletal warrior, {front view|three-quarter view|side profile}, {standing tall while holding a rusty longsword in its right hand and a cracked wooden shield in its left hand|raising a battered buckler in its left hand for defense while clutching a sharp mace in its right hand|aiming a heavy bone bow with both hands in a focused archery stance|lunging forward with a jagged iron spear held in both hands|crouched on one knee while wielding a heavy crude axe in both hands|bare bony hands in a menacing predatory pose}, {rusted iron breastplate|shredded battle-torn banner|ancient necklaces of bone|shattered legionnaire armor|broken ribs exposed}, bleached bones, glowing hollow eye sockets",
